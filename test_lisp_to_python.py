...
class TestPythonGenerator:
    ...
    def test_generate_addition(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("+"), NumberNode(1), NumberNode(2)])
        result = gen.generate(node)
        assert result == "(1 + 2)"

    def test_generate_multiple_addition(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("+"), NumberNode(1), NumberNode(2), NumberNode(3)])
        result = gen.generate(node)
        assert result == "((1 + 2) + 3)"
    ...
    def test_generate_nested_arithmetic(self):
        ...
        node = ListNode(
            [
                SymbolNode("*"),
                ListNode([SymbolNode("+"), NumberNode(1), NumberNode(2)]),
                NumberNode(3),
            ]
        )
        result = gen.generate(node)
    ...
    def test_generate_define(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("define"), SymbolNode("x"), NumberNode(10)])
        result = gen.generate(node)
        assert result == "x = 10"
    ...
    def test_generate_defun(self):
        ...
        node = ListNode(
            [
                ...
                ListNode([SymbolNode("*"), SymbolNode("x"), SymbolNode("x")]),
            ]
        )
        result = gen.generate(node)
    ...
    def test_generate_if(self):
        ...
        node = ListNode(
            [
                SymbolNode("if"),
                ListNode([SymbolNode(">"), SymbolNode("x"), NumberNode(5)]),
                NumberNode(1),
                NumberNode(0),
            ]
        )
    ...
    def test_generate_lambda(self):
        ...
        node = ListNode(
            [
                ...
                ListNode([SymbolNode("+"), SymbolNode("x"), SymbolNode("y")]),
            ]
        )
        result = gen.generate(node)
    ...
    def test_generate_function_call(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("square"), NumberNode(5)])
        result = gen.generate(node)
    ...
    def test_generate_comparison_operators(self):
        ...
        for lisp_op, python_op in operators.items():
            node = ListNode([SymbolNode(lisp_op), SymbolNode("x"), NumberNode(5)])
            result = gen.generate(node)
    ...
    def test_generate_error_binary_op_insufficient_args(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("+"), NumberNode(1)])
...
class TestLetExpressions:
    ...
    def test_let_error_wrong_args(self):
        gen = PythonGenerator()
        node = ListNode([SymbolNode("let"), NumberNode(5)])
